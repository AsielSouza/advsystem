...
const distributePercentuais = () => {
  ...
  if (advogadosSocios.value.length === 1) {
    advogadosSocios.value[0].percentual = percentualTotalGrupo
  } else {
    const percentualPorAdvogado = percentualTotalGrupo / advogadosSocios.value.length
